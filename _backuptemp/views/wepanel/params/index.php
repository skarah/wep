...
if(sizeof($model)>0)
        ...
        'columns'=>array(
				...
				'name'=>'title',
				'type'=>'raw',
				'value'=>'CHtml::link($data->title, "/wepanel/params/act/edit/item/".$data->id,array("title"=>"Редактировать запись в настройках"))',
				'filter'=>$model->title,
				),
                'value',
                'name',
                array(
					...
					'deleteButtonUrl'=>'Yii::app()->createUrl("/wepanel/params/act/delete", array("item"=>$data->id))',
					...
					'updateButtonUrl'=>'Yii::app()->createUrl("/wepanel/params/act/edit", array("item"=>$data->id))',

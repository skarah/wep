...
if(sizeof($model)>0)
        ...
        'columns'=>array(
				...
				'name'=>'name',
				'type'=>'raw',
				'value'=>'CHtml::link($data->name, "/wepanel/galleries/act/edit/item/".$data->id,array("title"=>"Редактировать галерею"))',
				'filter'=>$model->name,
				),
                array(
					'class'=>'CButtonColumn',
					...
					'deleteButtonUrl'=>'Yii::app()->createUrl("/wepanel/galleries/act/delete", array("item"=>$data->id))',
					...
					'updateButtonUrl'=>'Yii::app()->createUrl("/wepanel/galleries/act/edit", array("item"=>$data->id))',

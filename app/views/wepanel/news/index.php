...
if(sizeof($model)>0)
        ...
        'columns'=>array(
				...
				'name'=>'name',
				'type'=>'raw',
				'value'=>'CHtml::link($data->name, "/wepanel/news/act/edit/item/".$data->id,array("title"=>"Редактировать запись"))',
				'filter'=>$model->name,
				),
                'date',
                array(
					...
					'deleteButtonUrl'=>'Yii::app()->createUrl("/wepanel/news/act/delete", array("item"=>$data->id))',
					...
					'updateButtonUrl'=>'Yii::app()->createUrl("/wepanel/news/act/edit", array("item"=>$data->id))',
